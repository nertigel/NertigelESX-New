...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				if Config.displayHudFuelOnly then
					DrawAdvancedText(0.130 - x, 0.77 - y, 0.005, -0.0128, 0.6, fuel, 255, 255, 255, 255, 6, 1)
					DrawAdvancedText(0.150 - x, 0.77 - y, 0.005, -0.0064, 0.4, " Fuel", 255, 255, 255, 255, 6, 1)
				else
