...
--m.prefix = '^6[Los Santos Roleplay] '
m.prefix = '^7'
m.suffix = '^7.'
...
m.messages = {   
    '^*^1 Welcome to ^2NEW ERA RP^7! ^1Don\'t forget to join our ^4Discord ^7@ ^4discord.gg/p45d76q',
    '^*^1If you need help with anything feel free to /report or join our ^4Discord ^7@ ^4discord.gg/p45d76q',
}
