...
Config.Price		= 1000 -- pound price to get vehicle back
...
Config.Garages = {
	Garage_Centre = {
		...
		SpawnPoint = {
			...
			HelpPrompt = "Press ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x=215.124, y=-791.377, z=30.946},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
	Garage_NightClub = {
...
Config.GaragesMecano = {
	Bennys = {
		...
		SpawnPoint = {
			...
			Heading = 303.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ pour sortir un véhicule de fourrière"
		},
		DeletePoint = {
			Pos = {x = 459.733,y = -1890.335,z = 25.776},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ pour rentrer le véhicule en fourrière"
		}, 	
	},
	police = {
		Name = 'Fourriere Externe',
...
Config.BoatGarages = {
	BoatGarage_Centre = {
		...
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Press ~INPUT_PICKUP~ to open the garage boat",
		SpawnPoint = {
			Pos = {x = -736.47064208984,y = -1342.4702148438,z = 1.0 },
			Heading = 230.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to take out your boat"
		},
		DeletePoint = {
			Pos = {x = -740.06408691406,y = -1361.8474121094,z = 1.8801808655262 },
			Marker = { w= 3.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to get in your boat"
		}, 	
	},
}
...
Config.AirplaneGarages = {
	AirplaneGarage_Centre = {
		...
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Press ~INPUT_PICKUP~ to open the garage de aviation",
		SpawnPoint = {
			Pos = {x = -1280.1153564453,y = -3378.1647949219,z = 13.940155029297 },
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ pour sortir votre engin d'aviation"
		},
		DeletePoint = {
			Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ pour rentrer votre engin d'aviation"
		}, 	
	},
}